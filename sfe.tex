...
\Sectref{ex:goland-contours} to obtain starting points for tracing
...
\begin{figure}[ht]
		\includegraphics[height=8cm,width=10cm]{asy/optim4.pdf}
	\centering
	\caption{3 methods for the corrector process }\label{fig:optim}
\end{figure}
