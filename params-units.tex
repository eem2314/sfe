...
$\bar{V}$		& reduced true airspeed				& -					& -					& -						\\ \hline
...
\index{=sigma@$\Rsf$ reduced stability factor}\index{reduced!stability factor}
...
\index{=rv@$\bar{V}$ (reduced true airspeed)}\index{true airspeed!reduced}\index{airspeed!reduced}\index{reduced!airspeed}
\end{table}
